...
<div class="container" style="margin-top: 100px; margin-bottom: 100px">
  <h3>Setting rank players</h3>
  <style>
    option, input, select, #selecting {
      color: black;
    }
  </style>

  <form action="setRanks.php">
    <input name="steamid" type="text" id="playerSteamid"><br>
    <select name="rank">
      <option value="69" id="selecting">Owner</option>
      <option value="1" id="selecting">Moderator</option>
      <option value="0" id="selecting">Member</option>
    </select>
...
<br><br><br>
  <div id="BotInventory">
    <input id="getBotInv" type="button" value="Get bot inventory">
    <div class="botInv"></div>
  </div>
  <input id="tradeLink" type="text" placeholder="Tradelink to send items">
  <input id="sendItems" type="button" value="Send items to tradelink">
  <br><br><br>

  <h3>Draw winner - giveaways</h3>
  <input type="text" id="giveawayNumber" placeholder="Number of giveaway">
  <input type="button" onclick='PickWinner()' value="Draw winner">
</div>
</center>
...
function PickWinner()
{
    var numberGiveaway = $('#giveawayNumber').val();

    window.open('drawWinner.php?id=' + numberGiveaway);
}
