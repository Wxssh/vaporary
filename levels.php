...
<center>
<div class="container" style="width: 300px;margin-top: 100px; margin-bottom: 100px">
      <table class="tabelul table table-striped" style="width:100%;">
        <thead>
           <tr>
            <th>Level</th>
            <th>Deposits needed</th>
          </tr>
        </thead>              
        <tbody>
  <?php
...
function LevelSystem()
{
  ...
  for($i = 1; $i <= $maxlevel; $i++)
  {
      ...
      echo '<tr><td>' . $i . '</td><td>$<span style="color:red">' . $xpMinus/100 . '</span>-<span style="color:red">' . $xpNeeded/100 . '</td></tr>';
  }
}
